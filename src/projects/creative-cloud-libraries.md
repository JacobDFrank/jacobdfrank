...
published: true
date: '2023-11-01'
description: Led design across two projects expanding Creative Cloud Libraries — adding save to libraries feature to Adobe Firefly and redesigning the Libraries & Brands experience using Spectrum.
...
<div class="cs-nav-anchor" id="firefly-design" data-label="Design of FF libraries"></div>
...
<div class="cs-image-row cs-image-row--2">
  <img src="/libraries/Move%20to%20library%20dialog%20mobile.png" alt="Create new library dialog in Firefly" />
  <img src="/libraries/Hover%20button.png" alt="Hover state of the save button in Firefly" />
</div>
...
<div class="cs-image-row cs-image-row--2 cs-image-row--tweets">
  <img src="/libraries/social/tweet-Julie.png" alt="Community post showing Save to Library in Firefly 2" />
  <img src="/libraries/social/tweet-kris.png" alt="Tutorial using Firefly assets with Libraries and Adobe Express" />
</div>

<div class="cs-image-row cs-image-row--2 cs-image-row--tweets">
  <img src="/libraries/social/tweet-barb.png" alt="Community post showing Firefly assets in Adobe Express library" />
...
<div class="cs-stats">
  <div class="cs-stats__item cs-stats__item--blue">
    <span class="cs-stats__number">18,000+</span>
    <span class="cs-stats__label">Free &amp; Paid users saved Firefly content to Libraries</span>
  </div>
  <div class="cs-stats__item">
    <span class="cs-stats__number">169,200+</span>
    <span class="cs-stats__label">generated images saved — 97% from Text to Image</span>
  </div>
  <div class="cs-stats__item">
  ...
  <div class="cs-stats__item">
    <span class="cs-stats__number">4,970+</span>
    <span class="cs-stats__label">new Libraries created directly from Firefly</span>
  </div>
  <div class="cs-stats__item">
    <span class="cs-stats__number">650+</span>
    <span class="cs-stats__label">net new Library users — first library ever created from Firefly</span>
  </div>
</div>
...
<div class="cs-nav-anchor" id="libraries-what-changed" data-label="What changed"></div>
