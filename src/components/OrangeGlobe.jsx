  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      loader.load(
        ...
        (gltf) => {
          ...
          model.traverse((child) => {
            ...
            ;(Array.isArray(child.material)
              ...
              // Force fully opaque — disable every transparency path:
              // opacity, alpha test, glTF transmission (KHR_materials_transmission),
              // and physical-glass thickness used by MeshPhysicalMaterial.
        ...
        (err) => {
          console.warn(
            'OrangeGlobe: /orange.glb not found — using fallback sphere.',
            err.message
          )
          group.add(
            new THREE.Mesh(
